...
<head>
    ...
    <link rel="stylesheet" href="{% static 'css/trianglearea.css' %}">
</head>
...
![output](./static/img/VOLUMEOFTHECYLINDER.png)

## RESULT:
Thus a website is designed for the Mathematical Calculations using JavaScript and is hosted in the URL http://surya.student.saveetha.in:8000/cylindervolume/ & http://surya.student.saveetha.in:8000/trianglearea/ .